...
public class Matrix {
	...
	public static int[][] buildMatrix(Scanner sc, int rowNum, int colNum) {
		...
		AStar.STARTROW = Integer.valueOf(lineArray[0]);
		AStar.STARTCOL = Integer.valueOf(lineArray[1]);
		AStar.ENDROW   = Integer.valueOf(lineArray[2]);
		AStar.ENDCOL   = Integer.valueOf(lineArray[3]);
